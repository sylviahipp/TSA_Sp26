...
print(Model_212)     # coefficients are all really high
...
Now that you have played with different order, let's try the auto.arima() function from the base package *stats*. The best fit for this time series is a ARIMA(1,1,2) with drift.
...
```{r}
## ERROR: can't run this because d = 0 and passed a non-stationary series
